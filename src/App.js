...
// Constants
const TWITTER_HANDLE = '0xJozeth';
const TWITTER_LINK = `https://twitter.com/0xJozeth`;
      ...
      {/* <div className="container"> */}
        <div className="header-container">
          ...
          <p className="sub-text">
            ...
            <p className="sub-text"> Connect your wallet and drop your best car GIF on to our <b>Metaverse</b> collection 👇 </p>
          </p>
